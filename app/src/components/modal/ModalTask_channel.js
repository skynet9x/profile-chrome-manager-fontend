...
function ModalTask_channel(props) {
                                        ...
                                        <div class="row g-20">
                                            ...
                                            { props.body.scheduler_action == "upload_video" ? (
                                             ...
                                             { props.body.scheduler_action == "create_playlist" ? (
                                                <>
                                                    <div class="col-sm-6">
                                                        <label for="courseTime" class="h5 mb-8 fw-semibold font-heading">Keyword Groups</label>
                                                        <div class="position-relative">
                                                            <select name="keyword_use" class="form-select py-9 placeholder-13 text-15" value={ props.body.keyword_use } onChange={ props.on_change }>
                                                                { props.body.keyword_groups.map((keyword) => (
                                                                    <option value={keyword.group}>{keyword.group}</option>
                                                                ) )}
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <label for="courseTime" class="h5 mb-8 fw-semibold font-heading">Video append</label>
                                                        <div class="position-relative">
                                                            <input type="text" class="text-counter placeholder-13 form-control py-11" name="video_append" value={ props.body.video_append_id } onChange={ props.on_change }/>
                                                        </div>
                                                    </div>
                                                </>
                                            ) : "" }
...
export default ModalTask_channel;
