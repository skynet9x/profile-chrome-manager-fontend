...
function Youtube_keyword_page() {
    ...
    var handle_search_query = async (e) => {
        ...
        var query = new URLSearchParams({
            page: page,
            limit: limitPage,
            keyword: query_ags_keyword,
            utm_source: query_ags_utm_source,
        }).toString();

        const res = await axiosClient({
            method: 'GET',
            url: '/youtube/keyword/?'+ query
        });
    ...
    var handle_import_keyword = async (e) => {
        if (e && e.preventDefault) {
            e.preventDefault(); 
        };
            ...
            <div class="dashboard-body">
                ...
                <div class="mt-24 card overflow-hidden">
                    ...
                    <div class="card-body p-0">
                        <table id="table_keyword_data" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="h6 text-gray-300">Keyword</th>
                            ...
                            <tbody>
                                {items.map((item) => (
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex-align gap-8">
                                                <span class="h6 mb-0 fw-medium text-gray-300 text-center" > {item.keyword} </span>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="h6 mb-0 fw-medium text-gray-300" > {item.utm_source} </span>
                                        </td>
                                        <td>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="card">
						...
						<div class="card-body">
							<form action="" onSubmit={handle_import_keyword}>
								<div class="row gy-20">
									<div class="col-12">
										<div class="row g-20">
											<div class="col-sm-12">
...
export default Youtube_keyword_page;
