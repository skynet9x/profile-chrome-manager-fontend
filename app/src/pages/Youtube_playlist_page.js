...
function Youtube_playlist_page() {
            ...
            <div class="dashboard-body">
                ...
                <div class="mt-24 card overflow-hidden">
                    ...
                    <div class="card-body p-0">
                        <table id="table_playlist_data" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="h6 text-gray-300"> Videos </th>
                            ...
                            <tbody>
                                {items.map((item) => (
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex-align gap-8">
                                                <a class="h6 mb-0 fw-medium " href={ "https://www.youtube.com/playlist?list=" + item.playlist_id} title={item.playlist_title} target="_blank" > {(item.playlist_title.length > 50) ? item.playlist_title.substr(0, 50) + "..." : item.playlist_title } </a>
                                            </div>
                                        </td>

                                        <td>
                                            <a class="h6 mb-0 fw-medium text-gray-300" href={ "https://www.youtube.com/channel/" + item.channel_id} target="_blank"> {item.channel_title} </a>
                                        </td>

                                        <td>
                                            <span class="h6 mb-0 fw-medium text-gray-300" > { JSON.parse(item.videos).length } </span>
                                        </td>
                                        

                                        <td>

                                            <span class="h6 mb-0 fw-medium text-gray-300" > {item.created_at} </span>
...
export default Youtube_playlist_page;
